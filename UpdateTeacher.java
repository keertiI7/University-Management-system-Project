...
public class UpdateTeacher extends JFrame implements ActionListener {
    ...
    UpdateTeacher() {
        ...
        loadData(labelname, labelfname, labeldob, labelx, labelxii, labelaadhar);
    }

    private void loadData(JLabel labelname, JLabel labelfname, JLabel labeldob, JLabel labelx, JLabel labelxii, JLabel labelaadhar) {
        try {
            Conn c = new Conn();
